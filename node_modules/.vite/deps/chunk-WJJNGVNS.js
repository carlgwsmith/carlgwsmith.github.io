...
} from "./chunk-TOO2UWEL.js";
import {
  require_jsx_runtime
} from "./chunk-RCSSST4A.js";
import {
  require_react
} from "./chunk-EGRNE5EW.js";
import {
  __commonJS,
  __toESM
    ...
    module.exports = function($$$config) {
          ...
          if (("forwards" === revealOrder || "backwards" === revealOrder) && void 0 !== nextProps && null !== nextProps && false !== nextProps)
            if (isArrayImpl(nextProps))
              for (var i3 = 0; i3 < nextProps.length; i3++) {
                if (!validateSuspenseListNestedChild(nextProps[i3], i3))
                  break a;
              }
      ...
      function readContextForConsumer(consumer, context2) {
        ...
        if (null === lastContextDependency) {
          ...
          lastContextDependency = lastContextDependency.next = context2;
        return value;
      }
      ...
      function doesRequireClone(current2, completedWork) {
        if (null !== current2 && current2.child === completedWork.child)
          return false;
        if (0 !== (completedWork.flags & 16))
          return true;
...
var is = {
  ...
  equ(a2, b2, {
    ...
    if (typeof a2 !== typeof b2 || !!a2 !== !!b2)
      return false;
    if (is.str(a2) || is.num(a2) || is.boo(a2))
      return a2 === b2;
    ...
    if (isObj && arrays === "shallow" && objects === "shallow") {
      for (i3 in strict ? b2 : a2)
        if (!is.equ(a2[i3], b2[i3], {
          strict,
          objects: "reference"
        }))
          return false;
    ...
    if (is.und(i3)) {
      if (isArr && a2.length === 0 && b2.length === 0)
        return true;
      if (isObj && Object.keys(a2).length === 0 && Object.keys(b2).length === 0)
        return true;
      if (a2 !== b2)
        return false;
    }
...
function dispose(obj) {
  if (obj.type !== "Scene")
    obj.dispose == null ? void 0 : obj.dispose();
  for (const p3 in obj) {
    const prop = obj[p3];
    if ((prop == null ? void 0 : prop.type) !== "Scene")
      prop == null ? void 0 : prop.dispose == null ? void 0 : prop.dispose();
  }
}
...
function invalidateInstance(instance) {
  ...
  if (state2 && state2.internal.frames === 0)
    state2.invalidate();
}
...
function createEvents(store) {
  ...
  function intersect(event, filter) {
    ...
    function handleRaycast(obj) {
      ...
      if (!state3 || !state3.events.enabled || state3.raycaster.camera === null)
        return [];
    ...
    if (state2.events.filter)
      hits = state2.events.filter(hits, state2);
    ...
    const rootState = {
      ...
      performance: {
        ...
        regress: () => {
          ...
          if (state3.performance.current !== state3.performance.min)
            setPerformanceCurrent(state3.performance.min);
...
function loadingFn(extensions, onProgress) {
  return function(Proto, ...input) {
    ...
    return Promise.all(input.map((input2) => new Promise((res, reject) => loader.load(input2, (data) => {
      if (isObject3D(data == null ? void 0 : data.scene))
...
function validateInstance(type, props) {
  ...
  if (props.args !== void 0 && !Array.isArray(props.args))
...
function createInstance(type, props, root) {
  ...
  if (type === "primitive" && (_props$object = props.object) != null && _props$object.__r3f)
...
function handleContainerEffects(parent, child, beforeChild) {
  ...
  if (!parent.parent && parent.object !== state2.scene)
    return;
  if (!child.object) {
...
function disposeOnIdle(object) {
  if (typeof object.dispose === "function") {
    ...
    if (typeof IS_REACT_ACT_ENVIRONMENT !== "undefined")
      ...
      (0, import_scheduler.unstable_scheduleCallback)(import_scheduler.unstable_IdlePriority, handleDispose);
  }
}
...
var reconciler = createReconciler({
  ...
  commitUpdate(instance, type, oldProps, newProps, fiber) {
    ...
    if (instance.type === "primitive" && oldProps.object !== newProps.object)
      reconstruct = true;
    else if (((_newProps$args = newProps.args) == null ? void 0 : _newProps$args.length) !== ((_oldProps$args = oldProps.args) == null ? void 0 : _oldProps$args.length))
      reconstruct = true;
    ...
    async configure(props = {}) {
      ...
      if (!state2.camera || state2.camera === lastCamera && !is.equ(lastCamera, cameraOptions, shallowLoose)) {
        ...
        if (!isCamera) {
          ...
          if (!state2.camera && !(cameraOptions != null && cameraOptions.rotation))
            camera.lookAt(0, 0, 0);
        }
        state2.set({
          camera
      ...
      if (events && !state2.events.handlers)
        state2.set({
          events: events(store)
        });
      ...
      if (dpr && state2.viewport.dpr !== calculateDpr(dpr))
        state2.setDpr(dpr);
      if (state2.frameloop !== frameloop)
        state2.setFrameloop(frameloop);
      if (!state2.onPointerMissed)
        state2.set({
          onPointerMissed
        });
      if (performance2 && !is.equ(performance2, state2.performance, shallowLoose))
        state2.set((state3) => ({
          performance: {
            ...state3.performance,
            ...performance2
      ...
      if (state2.legacy !== legacy)
        state2.set(() => ({
          legacy
        }));
      if (state2.linear !== linear)
        state2.set(() => ({
          linear
        }));
      if (state2.flat !== flat)
      ...
      if (state2) {
        setTimeout(() => {
          try {
            ...
            if ((_state$gl3 = state2.gl) != null && _state$gl3.xr)
              state2.xr.disconnect();
...
function update(timestamp, state2, frame2) {
  ...
  if (!state2.internal.priority && state2.gl.render)
    state2.gl.render(state2.scene, state2.camera);
...
function advance(timestamp, runGlobalEffects = true, state2, frame2) {
  ...
  if (!state2)
    ...
    update(timestamp, state2, frame2);
  if (runGlobalEffects)
    flushGlobalEffects("after", timestamp);
}
var DOM_EVENTS = {
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WJJNGVNS.js.map
